...
This is a web application that demonstrates the combination of using React with Rails in one application, that is to say, using react as the front-end and Rails as the back-end with Postgres as the the database 
...
Clone this repository to your desired folder: ` @https://github.com/bronnie313/hello-rails-react.git `
...
Install this project with: ` hello-rails-react  `
` gem install `
...
To run the project, execute the following command:` ./bin/dev `
...
You can deploy this project using: `https://github.com/bronnie313/hello-rails-react.git`
...
Feel free to check the [issues page](https://github.com/bronnie313/hello-rails-react/issues).
...
This project is [MIT](https://github.com/bronnie313/hello-rails-react/blob/develop/LICENSE) licensed.
